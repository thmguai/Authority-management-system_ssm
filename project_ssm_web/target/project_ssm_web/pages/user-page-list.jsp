	...
	<div class="wrapper">
										...
										<tr>
											...
											<td class="text-center">
												...
												<c:if test="${user.status == 1}">
													<a href="${pageContext.request.contextPath}/user/disableById?id=${user.id}" class="btn bg-olive btn-xs">禁用</a>
												</c:if>
												<c:if test="${user.status == 0}">
													<a href="${pageContext.request.contextPath}/user/ableById?id=${user.id}" class="btn bg-olive btn-xs">启用</a>
												</c:if>
											</td>
										</tr>
									</c:forEach>
		...
		<footer class="main-footer">
			...
			<strong>Copyright &copy; 2020 <a
					href="https://github.com/thmguai/">thmguai</a>.
			</strong> study hard.
		</footer>
		<!-- 底部导航 /-->
