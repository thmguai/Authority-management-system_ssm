...
<body class="hold-transition skin-purple sidebar-mini">
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<form action="${pageContext.request.contextPath}/product/updateById?id=${product.id}"
				method="post">
				<!-- 正文区域 -->
						...
						<div class="col-md-4 data">
							<div class="input-group date">
								...
								<input type="text" class="form-control pull-right"
									   value="${product.departureTimeStr}" id="datepicker-a3" name="departureTime">
							</div>
						</div>
				...
				<div class="box-tools text-center">
					<button type="submit" class="btn bg-maroon">更改</button>
